...
flags.DEFINE_string("task_name", 'quaro', "The name of the task to train.")

flags.DEFINE_string("vocab_file", './data/pretrained_model/uncased_base/vocab.txt',
                    "The vocabulary file that the BERT model was trained on.")

flags.DEFINE_string(
    "output_dir", './data/quaro/output',
...
flags.DEFINE_integer("log_step_count_steps", 1000,
                     "How many steps to print log info.")
